# Jeu De Canon
Interface graphique d'un jeu de canon développée en Python selon une architecture orientée objet. Le projet met en oeuvre la modélisation physique, la gestion des collision et une interface utilisateur interactive. Projet réalisé dans le cadre d'un cours à l'Université Laval.
...
- Animation du projectile en temps réel
- Système de progression par niveau
- Enregistrement du nom et du score du joueur
...
Le joueur ajuste l'angle et la puissance du tir. La trajectoire du projectile est calculée à l'aide de fonctions trigonométrique (module math). Une animation affiche le mouvement du tir en temps réel.
...
#### Progression du jeu
Lorsqu'une collision avec la cible est détectée, le joueur passe au niveau suivant. La cible est regénérée aléatoirement (module random), le score augmente et le compteur d'essais est réinitialisé.
...
#### Fin de partie et gestion des scores
